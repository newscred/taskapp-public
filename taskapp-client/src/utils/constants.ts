// APP TEXT
export const APP_TITLE = 'Tasks';
export const APP_DESCRIPTION = 'An app for creating and assigning tasks';
export const FOOTER_TEXT = `${new Date().getFullYear()} Optimizely`;
// PAGES TITLE
